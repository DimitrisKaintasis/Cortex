...
| Outcome learning | Retrieval audit, selected-evidence attribution, positive/negative updates, and versioned atom-tag/CO_USED/tag-relation channels; query↔selected-evidence updates currently match all-pairs final training and held-out quality with 48.8% fewer transitions, but transient held-out regression blocks promotion | Original used-chunk loop and Cortex interaction service |
