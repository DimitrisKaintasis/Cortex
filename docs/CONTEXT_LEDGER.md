...
| Outcome learning | Retrieval audit, selected-evidence attribution, positive/negative updates, and versioned atom-tag/CO_USED/tag-relation channels; first real policy ablation found atom-tag + CO_USED matched all-pairs retrieval with 88.2% fewer transitions | Original used-chunk loop and Cortex interaction service |
