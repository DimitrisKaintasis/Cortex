...
Data Retrieval is an auditable, adaptive evidence-selection system. It preserves canonical
source evidence, accepts replaceable derived interpretations, organizes all representations
through weighted concepts, and produces a compact evidence pack for an AI consumer.
...
7. Each capability must pass an isolated test before it enters a combined benchmark.
